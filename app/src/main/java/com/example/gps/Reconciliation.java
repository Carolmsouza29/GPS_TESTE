...
//Classe disponibilizada pelo professor, que realiza as operações da reconciliação
    ...
    public class Reconciliation {
        ...
        public String printMatrix(double[] _m) {
            ...
            if (_m != null) {
                ...
                aux = "the array has null data.";
            }
            return aux;
        }

        public ArrayList<Double> returnMatrix(double[] _m) {
            //Retorna um vetor de double ao inves de String do tempo de cada intervalo
